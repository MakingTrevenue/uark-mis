    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="myNavbar">
            ...
            <ul class="nav navbar-nav">
                ...
                <li class="dropdown">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">GA Tasks <span class="caret"></span></a>
                    <ul class="dropdown-menu">
                        <li><a href="./gaTask.php">Submit Task</a></li>
                        <li role="separator" class="divider"></li>
